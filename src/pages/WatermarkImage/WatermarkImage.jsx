  ...
  return (
    <div className='file-page-container'>
        <div className='file-page-header'>
            <h1 className='file-page-title'>Watermark Image</h1>
            <p className='file-page-description'>Add a text or image watermark to your images with customizable options.</p>
        </div>
            ...
            <div className="file-page-main">
                ...
                <div className="file-page-sidebar">
                    ...
                    {watermarkType === 'text' ? (
                        ...
                        <div className='settings-group'>
                             <div {...getWatermarkRootProps({ className: `dropzone-small ${isWatermarkDragActive ? 'drag-over' : ''}` })}>
                    ...
                    <div className="sidebar-buttons">
                        ...
                        <button className='back-button' onClick={handleBack}><FaArrowLeft /> Back</button>
                    </div>
                </div>
            </div>
        )}
